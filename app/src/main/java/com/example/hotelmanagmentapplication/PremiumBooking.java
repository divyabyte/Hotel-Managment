...
public class PremiumBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_premium_booking);
    ...
    public void PremiumBooking(View view) {
        ...
        Intent i = new Intent(PremiumBooking.this, BookingDone.class);
        startActivity(i);
    }
}
